...
API_ID = int(environ.get('API_ID', '22293838'))
API_HASH = environ.get('API_HASH', '5eb39d3199a80c0a72a37af5f51b7df6')
BOT_TOKEN = environ.get('BOT_TOKEN', "7214705270:AAGJ9mC3trlemWf6dfIhPjKPpSWoYhXqOgE")

# Bot settings
CACHE_TIME = int(environ.get('CACHE_TIME', 1800))
PICS = (environ.get('PICS', 'https://telegra.ph/file/2753ec1353e01414f0ff7.jpg')).split() #SAMPLE PIC
NOR_IMG = environ.get("NOR_IMG", "https://telegra.ph/file/2753ec1353e01414f0ff7.jpg")
MELCOW_VID = environ.get("MELCOW_VID", "https://t.me/How_To_Open_Linkl")
SPELL_IMG = environ.get("SPELL_IMG", "https://te.legra.ph/file/15c1ad448dfe472a5cbb8.jpg")

# Admins, Channels & Users
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002214373580'))
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '986693564 1717614003').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002082870465').split()]
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002026461119') # give your force subscribe channel id here else leave it blank
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://migih33102:kl0fnmPSCuLeVtOJ@cluster0.gshppxi.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+xf-ZCdd9kpQ0Y2M1')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/RP_Cinemas')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'RP_Cinemas') # Support Chat Link Without https:// or @
